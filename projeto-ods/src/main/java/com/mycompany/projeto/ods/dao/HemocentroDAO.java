...
/**
 * DAO responsável por todas as operações de banco relacionadas à entidade Hemocentro.
 *
 * Este DAO é o mais simples dos três porque a tabela locais_coleta contém apenas
 ...
 * Os hemocentros são dados de configuração da aplicação, inseridos pelo schema.sql.
...
public class HemocentroDAO {
     ...
     *
     * Este método existe porque a DoacaoScreen usa um JComboBox<String> que armazena
     * apenas o nome do hemocentro (não o objeto inteiro). Ao confirmar o agendamento,
     * a tela recupera o nome selecionado e precisa obter o ID do hemocentro correspondente
     * para salvar a doação. Buscar pelo nome exato é a ponte entre a UI e o banco nesse fluxo.
     *
     ...
     * hemocentros de nomes únicos inseridos pelo schema.sql, isso não é um problema.
     *
     * @return o Hemocentro encontrado, ou null se não existir
     ...
     * Todos os campos são INTEGER ou VARCHAR, sem necessidade de conversão especial.
     *
