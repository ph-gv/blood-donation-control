...
CREATE TABLE `doacoes` (
  ...
  `id_local_coleta` int(11) NOT NULL,
  `data` date NOT NULL,
  ...
  KEY `id_local_coleta` (`id_local_coleta`),
  CONSTRAINT `doacoes_ibfk_1` FOREIGN KEY (`id_doador`) REFERENCES `doadores` (`id`),
  CONSTRAINT `doacoes_ibfk_2` FOREIGN KEY (`id_local_coleta`) REFERENCES `locais_coleta` (`id`)
...
-- Dump completed on 2025-05-27 14:49:39
